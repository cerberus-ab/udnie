...
def _get_output_path(input_path, style_name, steps):
...
class Params:
    ...
    def of_args():
        ...
        parser.add_argument("--size", type=int, default=512,
                            help="Size of the images in the optimization")
        parser.add_argument("--show", action="store_true",
                            help="Show the styled image")

        args = parser.parse_args()
        output_path = _get_output_path(args.input, args.style, args.steps)
